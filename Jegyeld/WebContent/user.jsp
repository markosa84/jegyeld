...
<%@page
	import="hu.ak_akademia.jegyeld.dao.user.GetUserByEmailtSqlBuilder"%>
...
<body>
	...
	<%
	    ...
	    List<User> users = userDao.read(new GetUserByEmailtSqlBuilder(), new GetUserByEmailSqlWriter("teszt.elek@gmail.com"), new UserSqlReader());
